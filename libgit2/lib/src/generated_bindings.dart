...
class NativeLibrary {
  ...
  late final _error_set_str =
      _error_set_strPtr.asFunction<int Function(int, ffi.Pointer<ffi.Char>)>();
...
final class __darwin_sigaltstack extends ffi.Opaque {}
...
final class rusage_info_v6 extends ffi.Opaque {}
...
/// on `ls` calls.
final class git_remote_head extends ffi.Opaque {}
...
final class git_credential extends ffi.Opaque {}
...
final class git_cert extends ffi.Opaque {}
...
final class git_indexer_progress extends ffi.Opaque {}
...
final class git_push_update extends ffi.Opaque {}
...
final class git_diff_binary extends ffi.Opaque {}
...
final class git_diff_hunk extends ffi.Opaque {}
...
final class git_diff_line extends ffi.Opaque {}
...
final class git_diff_similarity_metric extends ffi.Opaque {}
...
sealed class git_checkout_strategy_t {
  /// < default is a dry run, no actual updates
  static const GIT_CHECKOUT_NONE = 0;
  ...
  static const GIT_CHECKOUT_SAFE = 1;

  /// Allow all updates to force working directory to look like index.
  ///
  /// Mutually exclusive with GIT_CHECKOUT_SAFE.
  /// GIT_CHECKOUT_FORCE takes precedence over GIT_CHECKOUT_SAFE.
  static const GIT_CHECKOUT_FORCE = 2;

  /// Allow checkout to recreate missing files
  static const GIT_CHECKOUT_RECREATE_MISSING = 4;

  /// Allow checkout to make safe updates even if conflicts are found
  static const GIT_CHECKOUT_ALLOW_CONFLICTS = 16;

  /// Remove untracked files not in index (that are not ignored)
  static const GIT_CHECKOUT_REMOVE_UNTRACKED = 32;

  /// Remove ignored files not in index
  static const GIT_CHECKOUT_REMOVE_IGNORED = 64;

  /// Only update existing files, don't create new ones
  static const GIT_CHECKOUT_UPDATE_ONLY = 128;

  /// Normally checkout updates index entries as it goes; this stops that.
  /// Implies `GIT_CHECKOUT_DONT_WRITE_INDEX`.
  static const GIT_CHECKOUT_DONT_UPDATE_INDEX = 256;

  /// Don't refresh index/config/etc before doing checkout
  static const GIT_CHECKOUT_NO_REFRESH = 512;

  /// Allow checkout to skip unmerged files
  static const GIT_CHECKOUT_SKIP_UNMERGED = 1024;

  /// For unmerged files, checkout stage 2 from index
  static const GIT_CHECKOUT_USE_OURS = 2048;

  /// For unmerged files, checkout stage 3 from index
  static const GIT_CHECKOUT_USE_THEIRS = 4096;

  /// Treat pathspec as simple list of exact match file paths
  static const GIT_CHECKOUT_DISABLE_PATHSPEC_MATCH = 8192;

  /// Ignore directories in use, they will be left empty
  static const GIT_CHECKOUT_SKIP_LOCKED_DIRECTORIES = 262144;

  /// Don't overwrite ignored files that exist in the checkout target
  static const GIT_CHECKOUT_DONT_OVERWRITE_IGNORED = 524288;

  /// Write normal merge files for conflicts
  static const GIT_CHECKOUT_CONFLICT_STYLE_MERGE = 1048576;

  /// Include common ancestor data in diff3 format files for conflicts
  static const GIT_CHECKOUT_CONFLICT_STYLE_DIFF3 = 2097152;

  /// Don't overwrite existing files or folders
  static const GIT_CHECKOUT_DONT_REMOVE_EXISTING = 4194304;

  /// Normally checkout writes the index upon completion; this prevents that.
  static const GIT_CHECKOUT_DONT_WRITE_INDEX = 8388608;

  /// Show what would be done by a checkout.  Stop after sending
  /// notifications; don't update the working directory or index.
  static const GIT_CHECKOUT_DRY_RUN = 16777216;

  /// Recursively checkout submodules with same options (NOT IMPLEMENTED)
  static const GIT_CHECKOUT_UPDATE_SUBMODULES = 65536;

  /// Recursively checkout submodules if HEAD moved in super repo (NOT IMPLEMENTED)
  static const GIT_CHECKOUT_UPDATE_SUBMODULES_IF_CHANGED = 131072;
}
...
/// being modified.
sealed class git_checkout_notify_t {
  static const GIT_CHECKOUT_NOTIFY_NONE = 0;

  /// Invokes checkout on conflicting paths.
  static const GIT_CHECKOUT_NOTIFY_CONFLICT = 1;

  /// Notifies about "dirty" files, i.e. those that do not need an update
  /// but no longer match the baseline.  Core git displays these files when
  /// checkout runs, but won't stop the checkout.
  static const GIT_CHECKOUT_NOTIFY_DIRTY = 2;

  /// Sends notification for any file changed.
  static const GIT_CHECKOUT_NOTIFY_UPDATED = 4;

  /// Notifies about untracked files.
  static const GIT_CHECKOUT_NOTIFY_UNTRACKED = 8;

  /// Notifies about ignored files.
  static const GIT_CHECKOUT_NOTIFY_IGNORED = 16;
  static const GIT_CHECKOUT_NOTIFY_ALL = 65535;
}

/// Checkout performance-reporting structure
final class git_checkout_perfdata extends ffi.Opaque {}
...
sealed class git_merge_analysis_t {
  /// No merge is possible.  (Unused.)
  static const GIT_MERGE_ANALYSIS_NONE = 0;

  /// A "normal" merge; both HEAD and the given merge input have diverged
  /// from their common ancestor.  The divergent commits must be merged.
  static const GIT_MERGE_ANALYSIS_NORMAL = 1;

  /// All given merge inputs are reachable from HEAD, meaning the
  /// repository is up-to-date and no merge needs to be performed.
  static const GIT_MERGE_ANALYSIS_UP_TO_DATE = 2;

  /// The given merge input is a fast-forward from HEAD and no merge
  /// needs to be performed.  Instead, the client can check out the
  /// given merge input.
  static const GIT_MERGE_ANALYSIS_FASTFORWARD = 4;

  /// The HEAD of the current repository is "unborn" and does not point to
  /// a valid commit.  No merge can be performed, but the caller may wish
  /// to simply set HEAD to the target commit(s).
  static const GIT_MERGE_ANALYSIS_UNBORN = 8;
}
...
final class git_credential_userpass_plaintext extends ffi.Opaque {}

/// Username-only credential information
final class git_credential_username extends ffi.Opaque {}

/// A key for NTLM/Kerberos "default" credentials
typedef git_credential_default = git_credential;

/// A ssh key from disk
final class git_credential_ssh_key extends ffi.Opaque {}

/// Keyboard-interactive based ssh authentication
final class git_credential_ssh_interactive extends ffi.Opaque {}

/// A key with a custom signature function
final class git_credential_ssh_custom extends ffi.Opaque {}
...
typedef git_credential_ssh_interactive_cbFunction = ffi.Void Function(
    ...
    ffi.Pointer<ffi.Pointer<ffi.Void>> abstract1);
...
final class git_config_entry extends ffi.Opaque {}
...
final class git_configmap extends ffi.Opaque {}
...
typedef git_trace_cbFunction = ffi.Void Function(
    ffi.UnsignedInt level, ffi.Pointer<ffi.Char> msg);
typedef Dartgit_trace_cbFunction = void Function(
    git_trace_level_t level, ffi.Pointer<ffi.Char> msg);

/// An instance for a tracing function
typedef git_trace_cb = ffi.Pointer<ffi.NativeFunction<git_trace_cbFunction>>;
...
sealed class git_status_t {
  static const GIT_STATUS_CURRENT = 0;
  static const GIT_STATUS_INDEX_NEW = 1;
  static const GIT_STATUS_INDEX_MODIFIED = 2;
  static const GIT_STATUS_INDEX_DELETED = 4;
  static const GIT_STATUS_INDEX_RENAMED = 8;
  static const GIT_STATUS_INDEX_TYPECHANGE = 16;
  static const GIT_STATUS_WT_NEW = 128;
  static const GIT_STATUS_WT_MODIFIED = 256;
  static const GIT_STATUS_WT_DELETED = 512;
  static const GIT_STATUS_WT_TYPECHANGE = 1024;
  static const GIT_STATUS_WT_RENAMED = 2048;
  static const GIT_STATUS_WT_UNREADABLE = 4096;
  static const GIT_STATUS_IGNORED = 16384;
  static const GIT_STATUS_CONFLICTED = 32768;
}
...
sealed class git_status_opt_t {
  /// Says that callbacks should be made on untracked files.
  /// These will only be made if the workdir files are included in the status
  /// "show" option.
  static const GIT_STATUS_OPT_INCLUDE_UNTRACKED = 1;

  /// Says that ignored files get callbacks.
  /// Again, these callbacks will only be made if the workdir files are
  /// included in the status "show" option.
  static const GIT_STATUS_OPT_INCLUDE_IGNORED = 2;

  /// Indicates that callback should be made even on unmodified files.
  static const GIT_STATUS_OPT_INCLUDE_UNMODIFIED = 4;

  /// Indicates that submodules should be skipped.
  /// This only applies if there are no pending typechanges to the submodule
  /// (either from or to another type).
  static const GIT_STATUS_OPT_EXCLUDE_SUBMODULES = 8;
  ...
  /// instead.
  static const GIT_STATUS_OPT_RECURSE_UNTRACKED_DIRS = 16;

  /// Indicates that the given path should be treated as a literal path,
  /// and not as a pathspec pattern.
  static const GIT_STATUS_OPT_DISABLE_PATHSPEC_MATCH = 32;

  /// Indicates that the contents of ignored directories should be included
  /// in the status. This is like doing `git ls-files -o -i --exclude-standard`
  /// with core git.
  static const GIT_STATUS_OPT_RECURSE_IGNORED_DIRS = 64;

  /// Indicates that rename detection should be processed between the head and
  /// the index and enables the GIT_STATUS_INDEX_RENAMED as a possible status
  /// flag.
  static const GIT_STATUS_OPT_RENAMES_HEAD_TO_INDEX = 128;

  /// Indicates that rename detection should be run between the index and the
  /// working directory and enabled GIT_STATUS_WT_RENAMED as a possible status
  /// flag.
  static const GIT_STATUS_OPT_RENAMES_INDEX_TO_WORKDIR = 256;

  /// Overrides the native case sensitivity for the file system and forces
  /// the output to be in case-sensitive order.
  static const GIT_STATUS_OPT_SORT_CASE_SENSITIVELY = 512;

  /// Overrides the native case sensitivity for the file system and forces
  /// the output to be in case-insensitive order.
  static const GIT_STATUS_OPT_SORT_CASE_INSENSITIVELY = 1024;

  /// Iindicates that rename detection should include rewritten files.
  static const GIT_STATUS_OPT_RENAMES_FROM_REWRITES = 2048;

  /// Bypasses the default status behavior of doing a "soft" index reload
  /// (i.e. reloading the index data if the file on disk has been modified
  /// outside libgit2).
  static const GIT_STATUS_OPT_NO_REFRESH = 4096;

  /// Tells libgit2 to refresh the stat cache in the index for files that are
  /// unchanged but have out of date stat einformation in the index.
  /// It will result in less work being done on subsequent calls to get status.
  /// This is mutually exclusive with the NO_REFRESH option.
  static const GIT_STATUS_OPT_UPDATE_INDEX = 8192;

  /// Normally files that cannot be opened or read are ignored as
  /// these are often transient files; this option will return
  /// unreadable files as `GIT_STATUS_WT_UNREADABLE`.
  static const GIT_STATUS_OPT_INCLUDE_UNREADABLE = 16384;

  /// Unreadable files will be detected and given the status
  /// untracked instead of unreadable.
  static const GIT_STATUS_OPT_INCLUDE_UNREADABLE_AS_UNTRACKED = 32768;
}
...
final class git_status_options extends ffi.Struct {
  ...
  @ffi.UnsignedInt()
  external int show1AsInt;

  git_status_show_t get show1 => git_status_show_t.fromValue(show1AsInt);
...
final class git_credential_userpass_payload extends ffi.Opaque {}

typedef git_commit_signing_cbFunction = ffi.Int Function(
    ffi.Pointer<git_buf> signature,
    ffi.Pointer<git_buf> signature_field,
    ffi.Pointer<ffi.Char> commit_content,
    ffi.Pointer<ffi.Void> payload);
typedef Dartgit_commit_signing_cbFunction = int Function(
    ffi.Pointer<git_buf> signature,
    ffi.Pointer<git_buf> signature_field,
    ffi.Pointer<ffi.Char> commit_content,
    ffi.Pointer<ffi.Void> payload);
...
typedef git_commit_signing_cb
    = ffi.Pointer<ffi.NativeFunction<git_commit_signing_cbFunction>>;
typedef git_cvar_map = git_configmap;
...
/// /
/// /**@{
typedef git_cred = git_credential;
typedef git_cred_userpass_plaintext = git_credential_userpass_plaintext;
typedef git_cred_username = git_credential_username;
typedef git_cred_default = git_credential_default;
typedef git_cred_ssh_key = git_credential_ssh_key;
typedef git_cred_ssh_interactive = git_credential_ssh_interactive;
typedef git_cred_ssh_custom = git_credential_ssh_custom;
typedef git_cred_acquire_cb = git_credential_acquire_cb;
typedef git_cred_sign_callback = git_credential_sign_cb;
typedef git_cred_sign_cb = git_credential_sign_cb;
typedef git_cred_ssh_interactive_callback = git_credential_ssh_interactive_cb;
typedef git_cred_ssh_interactive_cb = git_credential_ssh_interactive_cb;
typedef git_cred_userpass_payload = git_credential_userpass_payload;
...
/// /
/// /**@{
typedef git_trace_callback = git_trace_cb;
...
/// This type is deprecated, but there is no plan to remove this
/// type definition at this time.
typedef git_transfer_progress_cb = git_indexer_progress_cb;

/// Type definition for push transfer progress callbacks.
///
/// This type is deprecated, but there is no plan to remove this
/// type definition at this time.
typedef git_push_transfer_progress = git_push_transfer_progress_cb;
typedef git_headlist_cbFunction = ffi.Int Function(
    ffi.Pointer<git_remote_head> rhead, ffi.Pointer<ffi.Void> payload);
typedef Dartgit_headlist_cbFunction = int Function(
    ffi.Pointer<git_remote_head> rhead, ffi.Pointer<ffi.Void> payload);

/// Callback for listing the remote heads
typedef git_headlist_cb
    = ffi.Pointer<ffi.NativeFunction<git_headlist_cbFunction>>;
